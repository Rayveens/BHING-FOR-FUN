...
void ScreenInfo::OnLoad() {
	LoadConfig();
		...
		buffs = 
		{ 
			STATE_EMPOWER, STATE_ENERGYSHIELD, STATE_FLAMMINGARMOR, STATE_HOLYSHIELD, STATE_MAGIC_REINFORCEMENT, STATE_SHOUT, STATE_BATTLEORDERS, STATE_BATTLECOMMAND, STATE_CONCENTRATE, STATE_FRENZY, STATE_WHIRLING_DESTRUCTION, STATE_BERSERK, STATE_CYCLONEARMOR, STATE_HURRICANE, STATE_ARMAGEDDON, STATE_WOLF, STATE_BEAR, STATE_VENOMCLAWS, STATE_QUICKNESS, STATE_CLOAK_OF_SHADOWS,STATE_FADE,STATE_SHRINE_EXPERIENCE,
			//auras
			STATE_BONEGOLEMAURA, STATE_STONEGOLEMAURA, STATE_AQUAGOLEMAURA, STATE_FLAMEGOLEMAURA, STATE_POISONGOLEMAURA, STATE_MIGHT ,STATE_PRAYER, STATE_RESISTFIRE, STATE_HOLYFIRE, STATE_THORNS, STATE_DEFIANCE, STATE_RESISTCOLD, STATE_BLESSEDAIM, STATE_CLEANSING, STATE_RESISTLIGHT, STATE_CONCENTRATION, STATE_HOLYWIND, STATE_STAMINA, STATE_HOLYSHOCK, STATE_HORADRICPRESS, STATE_MEDITATION, STATE_FANATICISM, STATE_REDEMPTION, STATE_CONVICTION, STATE_RESISTALL, STATE_GAIAAURA, STATE_FROZENAURA, STATE_MAGMAAURA, STATE_DESOLATEAURA, STATE_HIGHBLESSING, STATE_ANCIENTNEPPOWER, STATE_PRISMATIC_FORCE, STATE_GSA1, STATE_ESA1, STATE_ARA1, STATE_CONVICTIONMAGICPHYS_STATE, STATE_OAKSAGE, STATE_WOLVERINE, STATE_BARBS,
			//debuffs
			STATE_AMPLIFYDAMAGE, STATE_DIMVISION, STATE_WEAKEN, STATE_IRONMAIDEN, STATE_OVERWHELMING_PRESSENCE, STATE_CONFUSE, STATE_LIFETAP, STATE_ATTRACT, STATE_DECREPIFY, STATE_LOWERRESIST, STATE_COLD, STATE_POISON
		};

	
	buffNames = 
	{ 
				L"Empoderamiento Elemental", L"Escudo de Energia", L"Armadura de Ascuas", L"Escudo Sagrado", L"Ordenes Magicas", L"Ordenes Defensivas", L"Ordenes de Batalla", L"Ordenes de Guerra", L"Concentrado", L"Frenesi", L"Destruccion Giratoria", L"Frenetico", L"Armadura Ciclon", L"Huracan", L"Armagedon", L"Hombre Lobo", L"Hombre Oso", L"Garras Venenosas", L"Rapidez", L"Capa de Sombras", L"Fundido", L"Templo de Experiencia",
				L"Marca de Hueso", L"Marca de Rayo", L"Marca de Agua", L"Marca de Fuego", L"Marca de Veneno", L"Voluntad", L"Plegaria", L"Proteccion al Fuego", L"Fuego Sacro", L"Remordimiento", L"Proteccion Divina", L"Proteccion al Frio", L"Objetivo Bendito", L"Purificacion", L"Proteccion al Rayo", L"Concentracion", L"Hielo Sacro", L"Vigor", L"Rayo Sacro", L"Presencia Horadrica", L"Fanatismo", L"Redencion", L"Conviccion", L"Salvacion", L"Naturaleza Feroz", L"Naturaleza Oscura", L"Naturaleza Magmatica", L"Naturaleza Furiosa", L"Bendicion del Altocielo", L"Poder de Nephalem Ancestral", L"Fuerza Prismatica", L"Agilidad Suprema", L"Soberania Elemental", L"Presencia Ancestral", L"Fuerza Impia", L"Espiritu de Roble", L"Espiritu Lobezno", L"Espiritu Fortalezedor",
				L"Amplificar Daño", L"Vision Borrosa", L"Debilitar", L"Doncella de Hierro", L"Precencia Abrumadora", L"Confundir", L"Grifo de Vida", L"Atraer", L"Decrepitar", L"Disminuir Resistencias",  L"Escarchado", L"Envenenado", 
	};

	bhText = new Texthook(OutOfGame, 795, 6, BH_VERSION " (MapHack 1.0)");
...
void ScreenInfo::OnGameJoin() {
	...
	char* szDiff[3] = { "Tormento", "Hades", "Averno" };
...
void ScreenInfo::OnDraw() {
	...
	if (mpqH == NULL) {
		mpqH = D2WIN_LoadMpq(5000, "BSMH.dll", "buffs.mpq", "buffs", 0, 0);
	}
	if (!cellLoaded) {
		cf = D2WIN_LoadCellFile("data\\global\\ui\\spells\\BuffsBS", 0);
		cellLoaded = true;
	}
	...
	if (Toggles["Experience Meter"].state) {
		...
		Texthook::Draw((*p_D2CLIENT_ScreenSizeX / 2) + 78, *p_D2CLIENT_ScreenSizeY - 55, Center, 6, White, "%s", sExp);
	}
	...
	if (cf) {
			...
			for (unsigned int i = 0; i < buffs.size(); i++) {
				...
				if (state != 0 && !buffFound) {
					...
					if (manageConv && buffs[i] == STATE_CONVICTION) {
						...
						newBuff.isBuff = i < 61 ? true : false;
					}
		...
		int buffY = screenY - 55;
		int debuffY = screenY - 55;
		int totalBuffs = 0;

		for (unsigned i = 0; i < activeBuffs.size(); i++) {
			if (totalBuffs % 18 == 0 && totalBuffs != 0) {
				buffX = 117;
			...
			int col = activeBuffs[i].isBuff ? 0 : 1; //3=Blue, 1=Red;
...
StateCode StateCodes[] = {
	...
	{"THAWING", 179},
	{"STAMINAPOT", 180},
	{"PASSIVE_RESISTFIRE", 181},
	{"PASSIVE_RESISTCOLD", 182},
	{"PASSIVE_RESISTLTNG", 183},
	{"UBERMINION", 184},
	{"PASSIVE_MAG2_MASTERY", 185},
	{"PASSIVE_POIS_MASTERY", 186},
	{"PASSIVE_MAG_PIERCE", 187},
	{"PURPLE_GRIP", 188},
	{"CELESTIAL_WINGS", 189},
	{"AQUAGOLEMAURA", 190},
	{"NEPHALEM SEAL", 191},
	...
	{"FLAMMING_WINGS", 203},
	{"HIGHBLESSING", 204},
	{"CONVICTIONMAGICPHYS_STATE", 205},
	{"FLAMEGOLEMAURA", 206},
	{"STONEGOLEMAURA", 207},
	{"UNIVERSE", 208},
	{"LIGTHNINGGOLEMEFFECT", 209},
	{"POISONGOLEMEFFECT", 210},
	{"POISONGOLEMAURA", 211},
	{"EPICVENOM", 212},
	{"FIREWING", 213},
	{"GAIAAURA", 214},
	...
	{"DISPONIBLE25", 234},
	{"STATE16", 235},
	{"RESISTALL_TRAXTER", 236},
	{"CONVICTION_TRAXTER", 237},
	{"PRISMATIC_FORCE", 238},
	{"SESS_EVILAURA", 239},
	{"GSA1", 240},
	{"ESA1", 241},
	...
	{"HOLYBURN", 243},
	{"BURNINGZOMBIE", 244},
	{"MAGIC_REINFORCEMENT", 245},
	{"BACTRAINING", 246},
	{"BUTCHER_MADNESS", 247},
	{"HORADRICPRESS", 248},
	{"INNERBEAST", 249},
	{"OVERWHELMING_PRESSENCE", 250},
	{"NECROMANCYMASTERY", 251},
	{"PALADINSBLOOD", 252},
	{"WHIRLING_DESTRUCTION", 253},
	{"FLAMMINGARMOR", 254}
};
