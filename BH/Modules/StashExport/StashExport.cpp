...
void StashExport::OnLoad() {
	...
	settingsTab = new UITab("Stash", BH::settingsUI);

	int y = 15;
	new Checkhook(settingsTab, 4, y, &Toggles["Include Equipment"].state, "Incluir Equipo");
	new Checkhook(settingsTab, 4, (y+=15), &Toggles["Include Fixed Stats"].state, "Incluir Stats Fijos");
	new Checkhook(settingsTab, 4, (y += 15), &Toggles["Condense Stats"].state, "Condensar Stats");
	new Checkhook(settingsTab, 4, (y += 15), &Toggles["Export On Menu"].state, "Exportar Al Salir");
