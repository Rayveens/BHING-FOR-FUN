...
#define STAT_PASSIVEMAGICDMGMASTERY	359
#define STAT_PHYSABSPERCENT			360
#define STAT_PHYSABS				361
#define STAT_POISONABSORBPERCENT	362
#define STAT_POISONABSORB			363
#define STAT_PHYSPIERCEPERCT		371
...
enum D2States
{
	...
	STATE_PASSIVE_MAG2_MASTERY = 0xB9,
	STATE_PASSIVE_POIS_MASTERY = 0xBA,
	STATE_PASSIVE_MAG_PIERCE = 0xBB,
	STATE_PURPLE_GRIP = 0xBC,
	STATE_CELESTIAL_WINGS = 0xBD,
	STATE_AQUAGOLEMAURA = 0xBE,
	STATE_NEPHALEM_SEAL = 0xBF,
	STATE_VIOLET_RUSH = 0xC0,
	STATE_IMPERIAL_WINGS = 0xC1,
	STATE_HOLY_WINGS = 0xC2,
	STATE_AZTEC_WINGS = 0xC3,
	STATE_REFORGED_SOUL_WINGS = 0xC4,
	STATE_BLACKWINGS = 0xC5,
	STATE_BONEGOLEMAURA = 0xC6,
	STATE_DRAGONSHOT = 0xC7,
	STATE_HOPE_WINGS = 0xC8,
	STATE_TRUE_WINGS = 0xC9,
	STATE_IMPERIUS_WINGS = 0xCA,
	STATE_FLAMMING_WINGS = 0xCB,
	STATE_HIGHBLESSING = 0xCC,
	STATE_CONVICTIONMAGICPHYS_STATE = 0xCD,
	STATE_FLAMEGOLEMAURA = 0xCE,
	STATE_STONEGOLEMAURA = 0xCF,
	STATE_UNIVERSE = 0xD0,
	STATE_LIGTHNINGGOLEMEFFECT = 0xD1,
	STATE_POISONGOLEMEFFECT = 0xD2,
	STATE_POISONGOLEMAURA = 0xD3,
	STATE_EPICVENOM = 0xD4,
	STATE_FIREWING = 0xD5,
	STATE_GAIAAURA = 0xD6,
	STATE_FROZENAURA = 0xD7,
	STATE_BASEWINGSGOLD = 0xD8,
	STATE_BASEWINGSBLUE = 0xD9,
	STATE_BASEWINGSVENOM = 0xDA,
	STATE_MAGMAAURA = 0xDB,
	STATE_BASEWINGSWARRIOR = 0xDC,
	STATE_BASEWINGSDRAGON = 0xDD,
	STATE_DESOLATEAURA = 0xDE,
	STATE_MALTHAELWINGS = 0xDF,
	STATE_ANCIENTNEPPOWER = 0xE0,
	STATE_SILVERAURA = 0xE1,
	STATE_TEMP_ABSORBS = 0xE2,
	STATE_DISPONIBLE19 = 0xE3,
	STATE_WINGSBLACK1 = 0xE4,
	STATE_DISPONIBLE20 = 0xE5,
	STATE_DISPONIBLE21 = 0xE6,
	STATE_DISPONIBLE22 = 0xE7,
	STATE_DISPONIBLE23 = 0xE8,
	STATE_DISPONIBLE24 = 0xE9,
	STATE_DISPONIBLE25 = 0xEA,
	STATE_STATE16 = 0xEB,
	STATE_RESISTALL_TRAXTER = 0xEC,
	STATE_CONVICTION_TRAXTER = 0xED,
	STATE_PRISMATIC_FORCE = 0xEE,
	STATE_SESS_EVILAURA = 0xEF,
	STATE_GSA1 = 0xF0,
	STATE_ESA1 = 0xF1,
	STATE_ARA1 = 0xF2,
	STATE_HOLYBURN = 0xF3,
	STATE_BURNINGZOMBIE = 0xF4,
	STATE_MAGIC_REINFORCEMENT = 0xF5,
	STATE_BACTRAINING = 0xF6,
	STATE_BUTCHER_MADNESS = 0xF7,
	STATE_HORADRICPRESS = 0xF8,
	STATE_INNERBEAST = 0xF9,
	STATE_OVERWHELMING_PRESSENCE = 0xFA,
	STATE_NECROMANCYMASTERY = 0xFB,
	STATE_PALADINSBLOOD = 0xFC,
	STATE_WHIRLING_DESTRUCTION = 0xFD,
	STATE_FLAMMINGARMOR = 0xFE
...
#define	STATE_ELESHIELD					10
#define	STATE_COLD						11
#define	STATE_INFERNO					12
#define	STATE_POISONMASTERY				13
...
#define	STATE_GOLEM_MASTERY				111
...
#define	STATE_SUMMONRESIST				160
#define	STATE_OAKSAGECONTROL			161
#define	STATE_WOLVERINECONTROL			162
#define	STATE_BARBSCONTROL				163
#define	STATE_DEBUGCONTROL				164
...
#define	STATE_RESTINPEACE				172
#define	STATE_CORPSEEXP					173
#define	STATE_WHIRLWIND					174
#define	STATE_FULLSETGENERIC			175
#define	STATE_MONSTERSET				176
#define	STATE_DELERIUM					177
#define	STATE_ANTIDOTE					178
#define	STATE_THAWING					179
#define	STATE_STAMINAPOT				180
#define	STATE_PASSIVE_RESISTFIRE		181
#define	STATE_PASSIVE_RESISTCOLD		182
#define	STATE_PASSIVE_RESISTLTNG		183
#define	STATE_UBERMINION				184
#define	STATE_PASSIVE_MAG2_MASTERY		185
#define	STATE_PASSIVE_POIS_MASTERY		186
#define	STATE_PASSIVE_MAG_PIERCE		187
#define	STATE_PURPLE_GRIP				188
#define	STATE_CELESTIAL_WINGS			189
#define	STATE_AQUAGOLEMAURA				190
#define	STATE_NEPHALEM_SEAL				191
#define	STATE_VIOLET_RUSH				192
#define	STATE_IMPERIAL_WINGS			193
#define	STATE_HOLY_WINGS				194
#define	STATE_AZTEC_WINGS				195
#define	STATE_REFORGED_SOUL_WINGS		196
#define	STATE_BLACKWINGS				197
#define	STATE_BONEGOLEMAURA				198
#define	STATE_DRAGONSHOT				199
#define	STATE_HOPE_WINGS				200
#define	STATE_TRUE_WINGS				201
#define	STATE_IMPERIUS_WINGS			202
#define	STATE_FLAMMING_WINGS			203
#define	STATE_HIGHBLESSING				204
#define	STATE_CONVICTIONMAGICPHYS_STATE	205
#define	STATE_FLAMEGOLEMAURA			206
#define	STATE_STONEGOLEMAURA			207
#define	STATE_UNIVERSE					208
#define	STATE_LIGTHNINGGOLEMEFFECT		209
#define	STATE_POISONGOLEMEFFECT			210
#define	STATE_POISONGOLEMAURA			211
#define	STATE_EPICVENOM					212
#define	STATE_FIREWING					213
#define	STATE_GAIAAURA					214
#define	STATE_FROZENAURA				215
#define	STATE_BASEWINGSGOLD				216
#define	STATE_BASEWINGSBLUE				217
#define	STATE_BASEWINGSVENOM			218
#define	STATE_MAGMAAURA					219
#define	STATE_BASEWINGSWARRIOR			220
#define	STATE_BASEWINGSDRAGON			221
#define	STATE_DESOLATEAURA				222
#define	STATE_MALTHAELWINGS				223
#define	STATE_ANCIENTNEPPOWER			224
#define	STATE_SILVERAURA				225
#define	STATE_TEMP_ABSORBS				226
#define	STATE_DISPONIBLE19				227
#define	STATE_WINGSBLACK1				228
#define	STATE_DISPONIBLE20				229
#define	STATE_DISPONIBLE21				230
#define	STATE_DISPONIBLE22				231
#define	STATE_DISPONIBLE23				232
#define	STATE_DISPONIBLE24				233
#define	STATE_DISPONIBLE25				234
#define	STATE_STATE16					235
#define	STATE_RESISTALL_TRAXTER			236
#define	STATE_CONVICTION_TRAXTER		237
#define	STATE_PRISMATIC_FORCE			238
#define	STATE_SESS_EVILAURA				239
#define	STATE_GSA1						240
#define	STATE_ESA1						241
#define	STATE_ARA1						242
#define	STATE_HOLYBURN					243
#define	STATE_BURNINGZOMBIE				244
#define	STATE_MAGIC_REINFORCEMENT		245
#define	STATE_BACTRAINING				246
#define	STATE_BUTCHER_MADNESS			247
#define	STATE_HORADRICPRESS				248
#define	STATE_INNERBEAST				249
#define	STATE_OVERWHELMING_PRESSENCE	250
#define	STATE_NECROMANCYMASTERY			251
#define	STATE_PALADINSBLOOD				252
#define	STATE_WHIRLING_DESTRUCTION		253
#define	STATE_FLAMMINGARMOR				254
...
#define MAP_A1_THE_SECRET_COW_LEVEL				0x27
#define	MAP_A1_GREATER_RIFT_1					0x89
#define	MAP_A1_TYRAEL					        0x8F
#define	MAP_A1_COW_LV2				        	0x93
#define	MAP_A1_OLD_TRISTAM				    	0x95
#define	MAP_A1_ROAD_CORRUPTED					0xA0
#define	MAP_A1_TEMPLE_ROAD					    0xA1
#define	MAP_A1_PARAMO					        0xA2
#define	MAP_A1_SENDERO_DEL_VIAJERO_OSCURO_1		0xA3
#define	MAP_A1_SENDERO_DEL_VIAJERO_OSCURO_2		0xA4
#define	MAP_A1_SENDERO_DEL_VIAJERO_OSCURO_3		0xA5
#define	MAP_A1_SENDERO_DEL_VIAJERO_OSCURO_4		0xA6
#define	MAP_A1_NEPHALEM_RUINS_1					0xB6
#define	MAP_A1_NEPHALEM_RUINS_2					0xB7
#define	MAP_A1_NEPHALEM_RUINS_3					0xB8
#define	MAP_A1_NEPHALEM_RUINS_4					0xB9
#define	MAP_A1_NEPHALEM_RUINS_5					0xBA
#define	MAP_A1_NEPHALEM_RUINS_6					0xBB
#define	MAP_A1_NEPHALEM_RUINS_7					0xBC
#define	MAP_A1_NEPHALEM_RUINS_8					0xBD
#define	MAP_A1_NEPHALEM_RUINS_9					0xBE
#define	MAP_A1_NEPHALEM_RUINS_10				0xBF
#define	MAP_A1_NEPHALEM_RUINS_11				0xC0
#define	MAP_A1_NEPHALEM_RUINS_12				0xC1
#define	MAP_A1_NEPHALEM_RUINS_13				0xC2
#define	MAP_A1_NEPHALEM_RUINS_14				0xC3
#define	MAP_A1_NEPHALEM_RUINS_15				0xC4
#define	MAP_A1_NEPHALEM_RUINS_16				0xC5
#define	MAP_A1_NEPHALEM_RUINS_17				0xC6
#define	MAP_A1_NEPHALEM_RUINS_18				0xC7
#define	MAP_A1_NEPHALEM_RUINS_19				0xC8
#define	MAP_A1_NEPHALEM_RUINS_20				0xC9
#define	MAP_A1_NEPHALEM_RUINS_21				0xCA
#define	MAP_A1_NEPHALEM_RUINS_22				0xCB
#define	MAP_A1_NEPHALEM_RUINS_23				0xCC
#define	MAP_A1_NEPHALEM_RUINS_24				0xCD
#define	MAP_A1_NEPHALEM_RUINS_25				0xCE
#define	MAP_A1_NEPHALEM_RUINS_26				0xCF
#define	MAP_A1_NEPHALEM_RUINS_27				0xD0
#define	MAP_A1_NEPHALEM_RUINS_28				0xD1
#define	MAP_A1_NEPHALEM_RUINS_29				0xD2
#define	MAP_A1_NEPHALEM_RUINS_30				0xD3
#define	MAP_A1_NEPHALEM_REST					0xD4
#define	MAP_A1_UNKNOWN_EVENT					0xDF
...
#define	MAP_A2_GREATER_RIFT_2					0x8A
#define	MAP_A2_DAMNED_SANCTUARY					0x90
#define	MAP_A2_LOST_TEMPLE_1					0xB0
#define	MAP_A2_LOST_TEMPLE_2					0xB1
#define	MAP_A2_LOST_TEMPLE_3					0xB2
#define	MAP_A2_LOST_TEMPLE_4					0xB3
#define	MAP_A2_LOST_TEMPLE_5					0xB4
#define	MAP_A2_TRAXTER					        0xD5
#define	MAP_A2_CRUCIBLE_OF_FAITH				0xD7
#define	MAP_A2_ENIGMA1					        0xD8
#define	MAP_A2_ENIGMA2					        0xD9
#define	MAP_A2_ENIGMA3					        0xDA
#define	MAP_A2_ENIGMA4					        0xDB
#define	MAP_A2_ENIGMA5					        0xDC
#define	MAP_A2_ENIGMA6					        0xDD
#define	MAP_A2_ENIGMA7					        0xDE
#define	MAP_A2_ENIGMA9					        0xE0
#define	MAP_A2_ENIGMA10					        0xE1
#define	MAP_A2_INFINITEROOM1					0xE4
#define	MAP_A2_INFINITEROOM2					0xE5
#define	MAP_A2_INFINITEROOM3					0xE6
#define	MAP_A2_INFINITEROOM4					0xE7
#define	MAP_A2_INFINITEROOM5					0xE8
#define	MAP_A2_INFINITEROOM6					0xE9
#define	MAP_A2_INFINITEROOM7					0xEA
#define	MAP_A2_INFINITEROOM8					0xEB
#define	MAP_A2_INFINITEROOM9					0xEC
#define	MAP_A2_INFINITEROOM10					0xED
#define	MAP_A2_INFINITEROOM11					0xEE
#define	MAP_A2_INFINITEROOM12					0xEF
#define	MAP_A2_INFINITEROOM13					0xF0
#define	MAP_A2_INFINITEROOM14					0xF1
#define	MAP_A2_INFINITEROOM15					0xF2
#define	MAP_A2_INFINITEROOM16					0xF3
...
#define	MAP_A3_GREATER_RIFT_3					0x8B
#define	MAP_A3_INFERNAL_TOWER					0x96
#define	MAP_A3_CORRUPTED_TRAVINCAL				0x97
#define	MAP_A3_DOOMED_TOMB					    0x98
#define	MAP_A3_WICKED_MONASTERY					0x99
#define	MAP_A3_UNDEAD_CAVERN					0x9A
#define	MAP_A3_CORRUPTED_HARROGATH				0x9B
#define	MAP_A3_CORRUPTED_ISLAND					0x9C
#define	MAP_A3_LONGLEAT_LABYRINTH				0x9D
#define	MAP_A3_REIGNAC_LABYRINTH				0x9E
#define	MAP_A3_HEART_OF_SANCTUARY				0x9F
#define	MAP_A3_MOGON_KANN					    0xD6
#define	MAP_A3_REIGNAC_LAB_1					0xE2
#define	MAP_A3_REIGNAC_LAB_2					0xE3
...
#define	MAP_A4_GREATER_RIFT_4					0x8C
#define	MAP_A4_REALM_OF_SIN				     	0x8D
#define	MAP_A4_CURSED_KEEP				    	0x91
#define	MAP_A4_NORTHS_DUNGEON					0x92
...
#define	MAP_A5_MALTHAEL_MAP					    0x8E
#define	MAP_A5_ROAD_DIVINE				    	0x94
#define	MAP_A5_LOST_TOWER					    0xA7
#define	MAP_A5_LOST_TOWER_2					    0xA8
#define	MAP_A5_LOST_TOWER_3					    0xA9
#define	MAP_A5_LOST_TOWER_4					    0xAA
#define	MAP_A5_LOST_TOWER_5					    0xAB
#define	MAP_A5_LOST_CHAOS					    0xAC
#define	MAP_A5_LOST_CHAOS_2					    0xAD
#define	MAP_A5_DESTRUCTION_CASTLE				0xAE
#define	MAP_A5_RIVER_OF_CASTLE					0xAF
#define	MAP_A5_THE_SUPREME					    0xB5
#define	MAP_A4_DEVASTATED_SQUARE				0xF4
